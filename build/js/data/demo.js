...
export const demoData = {
    label: 'Synthetic fallback dataset — ScriptsBits data not loaded', isDemo: true, players, titles: { prefixes: [], suffixes: [] },
    simulation: { iterations: 3000, optimizerIterations: 250, rankingIterations: 1000, seed: 20260811, maxLookaheadTokens: 1, scoring: { retainedGamesPerSeries: 2, retainedSeries: 1, thirdGameProbability: 0.407 } },
