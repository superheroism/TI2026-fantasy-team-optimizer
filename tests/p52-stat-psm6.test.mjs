...
test('PSM6 stat recovery still requires centralized structured evidence gates',()=>{assert.ok(source.includes("acceptsStatEvidence(sm.score,sc,sm.score-sm.runnerUpScore,sm.value.replace(/[^A-Za-z0-9]/g,'').length,confidenceFor(raw,sp))"));});
